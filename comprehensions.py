...
# ip: L1=['a',8,3.4,[6,4],89] L2=[10,3.4,';hello',9,[5,6]]
# o/p: {'a':10, 8: 3.4, 3.4:'hello',89: [5,6]}

inp1 = ['a', 8, 3.4, [6, 4], 89]
inp2 = [10, 3.4, 'hello', 9, [5,6]]

output = {inp1[i]: inp2[i] for i in range(len(inp1)) if isinstance(inp1[i], (int, float, str, tuple))}
print(output)
